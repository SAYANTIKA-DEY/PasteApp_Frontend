...
const Home = () => {
  ...
  function createPaste() {
    const paste = {
      title: title,
      content: value,
      _id: pasteId || Date.now().toString(36), // generate a unique ID based on timestamp
  ...
  return (
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-5 items-start">
        <div className="flex flex-row gap-7 align-middle justify-center place-content-between">
          <input
